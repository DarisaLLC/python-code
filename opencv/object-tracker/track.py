...
from trackers import CorrelationTracker
import argparse

ap = argparse.ArgumentParser()
ap.add_argument("-v","--video",help="(optional) video file...")
ap.add_argument("-t","--tracker",default="correlation",help="tracker to use (camshift/correlation)")
...
trackers = {"correlation":CorrelationTracker}
objTracker = None
